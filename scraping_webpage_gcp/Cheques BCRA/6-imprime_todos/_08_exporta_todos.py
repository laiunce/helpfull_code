...
df = pd.DataFrame(columns=['cuil','nro_cheque','fecha_rechazo','monto','fecha_pago','causal','revision','judicial','pago_multa','persona_juridica_relacionada','dias_pago_cheque','dias_pago_multa'])

for r in data:
    df.loc[len(df)] = [r[0],r[1],r[2],r[3],r[4],r[5],r[7],r[8],r[6],r[9],r[10],r[11]]
...
worksheet.write(0,6,'revision', titulo)
worksheet.write(0,7,'judicial', titulo)
worksheet.write(0,8,'Pago multa', titulo)
worksheet.write(0,9,'Persona Jurídica Relacionada', titulo)
worksheet.write(0,10,'Dias pago cheque', titulo)
worksheet.write(0,11,'Dias pago multa', titulo)
...
worksheet.conditional_format('I2:I999999', {'type': 'text',
                                         'criteria': 'containing',
                                         'value': 'IMPAGA',
